...
class DataIngestionConfig:
    def __init__(self,traning_pipeline_config:Training_pipeline_config):
        self.data_ingestion_dir:str=os.path.join(
            traning_pipeline_config.artifact_dir,training_pipeline.DATA_INGESTION_DIR_NAME
            )
...
class DataValidationConfig:
    def __init__(self,traning_pipeline_config:Training_pipeline_config):
        self.data_validation_dir:str=os.path.join(
            traning_pipeline_config.artifact_dir,training_pipeline.DATA_VALIDATION_DIR_NAME
            )
